...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Danh sách CBCCVC <span id="count_nghihuu_danhsach" class="badge badge-important">0</span></button>
  </li>
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Danh sách chờ duyệt nghỉ hưu <span id="count_nghihuu_choduyet" class="badge badge-important">0</span></button>
  </li>
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false"> Danh sách chờ xử lý nghỉ hưu <span id="count_nghihuu_chonghihuu" class="badge badge-important">0</span></button>
  </li>
   <li class="nav-item" role="presentation">
    <button class="nav-link" id="pills-nghihuu-tab" data-bs-toggle="pill" data-bs-target="#pills-nghihuu" type="button" role="tab" aria-controls="pills-nghihuu" aria-selected="false"> Danh sách đã nghỉ hưu <span id="count_nghihuu_danghihuu" class="badge badge-important">0</span></button>
  </li>
</ul>
<div class="tab-content" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    <div class="row">
        <div class="col-md-12 m-b-20" style="margin-bottom: 20px">
             
        </div>
    </div>
  <div id="gridSelectedCCVC">
                    
             </div>
     <div id="gridcongchucvienchuc">
                    
             </div>
   
         </div>
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
        <div id="gridSelectedDuyet">
 ...
 <div id="gridchoxuly">
   ...
   <div class="tab-pane fade" id="pills-nghihuu" role="tabpanel" aria-labelledby="pills-nghihuu-tab">
       
 <div id="griddanghihuu">
...
#pills-tab .badge-important{
 ...
 <script type="module" src='public/assets/hoso/quanlynghihuu.js'></script>
 <script type="module" src='public/assets/hoso/quanlycbccvc.js'></script>
@endsection
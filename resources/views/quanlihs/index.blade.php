...
<script type="text/javascript">
	document.getElementById("caysododv").style.display = "block";
	document.getElementById("caysododv").className = "active";

	window.onload = function() {
		axios.get('getcoquan').then(function (response) {

<div class="row">
    <div class="col-12">
        <div class="toolbox">
            <button id="hienThiBaoCao" class="btn btn-info btn-sm">Hiển thị báo cáo</button>
...
<div class="row">
    <div class="col-12">
        <h3 class="heading">
            Báo cáo số lượng, chất lượng công chức từ cấp huyện trở lên (BM01/BNV ban hành kèm theo Thông tư
    ...
    <div class="col-6">
        ...
        <hr/>
        <label class="full-width"><input type="checkbox" value="5" id="chkHopDongChiTieu"/>Hợp đồng trong chỉ
            tiêu</label>
        <label class="full-width"><input type="checkbox" id="chkBienCheHanhChinh"/>Biên chế hành chính</label>
        <label class="full-width"><input type="checkbox" value="4" id="chkHopDong68CP"/>Hợp đồng 68 CP</label>
        <label class="full-width"><input type="checkbox" value="6" id="chkDonViTuHopDong"/>Đơn vị tự hợp đồng</label>
        <label class="full-width"><input type="checkbox" id="chkHopDongThuHut"/>Hợp dồng thu hút đề án nhân lực
            cao</label>
        <label class="full-width"><input type="checkbox" id="chkHopDongVuViec"/>Hợp đồng vụ việc</label>
        <label class="full-width"><input type="checkbox" id="chkHopDongKhac"/>Hợp đồng khác</label>
    </div>
    <div class="col-6">
        ...
        <table>
            <tr>
                ...
                <td>
                    <input id="txtDoTuoi" type="number" placeholder="Nhập tuổi" class="form-control">
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <select id="sltNgach" class="form-control">
            ...
            <tr>
                <td colspan="2">
                    <select id="sltTrihDoChuyenMon" class="form-control">
            ...
            <tr>
                <td colspan="2">
                    <select id="sltMoRongDonVi" class="form-control">
            ...
            <tr>
                <td colspan="2">
                    <select id="sltMoRongLoaiHinhBienChe" class="form-control">
    ...
    <div class="col-12" style="overflow: scroll; background: white">
		...
		Trên tuổi nghỉ hưu</span></th>
            ...
            <tbody id="bodyBaoCaoChatLuongCongChuc">
            </tbody>
        </table>
    </div>
